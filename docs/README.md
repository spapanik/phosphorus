...
been heavily influenced by [poetry][poetry]. There main goal of phosphorus is to have no
external dependencies, although pip itself is used, as it is almost universally installed.
