...
class MarkerAtom:
    ...
    def evaluate(self, extra: str = "") -> bool:
        ...
        raise UnreachableCodeError("All cases are handled")
...
class MarkerParser:
    ...
    def parse_marker_op(self) -> ComparisonOperator:
        ...
        raise ValueError("Expected a marker operator.")
    ...
    def parse_marker_var_or_str(self) -> MarkerVariable | str:
        ...
        raise ValueError("Expected a marker variable")
    ...
    def read(self) -> Token:
        ...
        if token is None:
            raise RuntimeError("No token to read")
